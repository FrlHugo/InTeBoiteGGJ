...
namespace Coherence.Generated
{
	...
	public class CoherenceSyncM_Pepatoes_id1 : CoherenceSyncBaked
	{
		...
		protected void Awake()
		{
			...
			logger = coherenceSync.logger.With<CoherenceSyncM_Pepatoes_id1>();
		}
		...
		public override void ReceiveCommand(IEntityCommand command)
		{
			...
			{
				default:
					logger.Warning($"[CoherenceSyncM_Pepatoes_id1] Unhandled command: {command.GetType()}.");
					break;
			}
		}
	}
