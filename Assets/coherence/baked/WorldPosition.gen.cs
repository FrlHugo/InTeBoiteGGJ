...
namespace Coherence.Generated
{
	...
	public struct WorldPosition : ICoherenceComponentData
	{
		...
		public static (WorldPosition, uint, uint?) DeserializeArchetypeExampleCharacter_3b63255ecbc45c94189e0899a9d151a2_WorldPosition_LOD0(InProtocolBitStream bitStream)
		{
			var mask = (uint)0;
			var val = new WorldPosition();
			if (bitStream.ReadMask())
		...
		public static (WorldPosition, uint, uint?) DeserializeArchetypePlayer_d076185600ad3c7489ff1b08d88bdda7_WorldPosition_LOD0(InProtocolBitStream bitStream)
		{
			var mask = (uint)0;
			var val = new WorldPosition();
			if (bitStream.ReadMask())
		...
		public static (WorldPosition, uint, uint?) DeserializeArchetypeM_Pepatoes_19914e9baa5282848b7dfb54e056fe69_WorldPosition_LOD0(InProtocolBitStream bitStream)
		{
			var mask = (uint)0;
			var val = new WorldPosition();
			if (bitStream.ReadMask())
