...
namespace Coherence.Generated
{
	...
	public class CoherenceSyncCube_id2 : CoherenceSyncBaked
	{
		...
		protected void Awake()
		{
			...
			logger = coherenceSync.logger.With<CoherenceSyncCube_id2>();
		}
		...
		public override void ReceiveCommand(IEntityCommand command)
		{
			...
			{
				default:
					logger.Warning($"[CoherenceSyncCube_id2] Unhandled command: {command.GetType()}.");
					break;
			}
		}
	}
