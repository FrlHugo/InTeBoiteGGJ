...
namespace Coherence.Generated
{
	...
	public struct GenericScale : ICoherenceComponentData
	{
		...
		public static (GenericScale, uint, uint?) DeserializeArchetypeExampleCharacter_3b63255ecbc45c94189e0899a9d151a2_GenericScale_LOD0(InProtocolBitStream bitStream)
		{
			var mask = (uint)0;
			var val = new GenericScale();
			if (bitStream.ReadMask())
		...
		public static (GenericScale, uint, uint?) DeserializeArchetypePlayer_d076185600ad3c7489ff1b08d88bdda7_GenericScale_LOD0(InProtocolBitStream bitStream)
		{
			var mask = (uint)0;
			var val = new GenericScale();
			if (bitStream.ReadMask())
		...
		public static (GenericScale, uint, uint?) DeserializeArchetypeM_Pepatoes_19914e9baa5282848b7dfb54e056fe69_GenericScale_LOD0(InProtocolBitStream bitStream)
		{
			var mask = (uint)0;
			var val = new GenericScale();
			if (bitStream.ReadMask())
